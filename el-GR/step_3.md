...
![Ένα παράδειγμα του φύλλου σχεδίασης με δυνατότητα λήψης που μπορεί να συμπληρωθεί από ένα παιδί. Σχέδια ζωγραφικής με το χέρι γεμίζουν τα έξι ορθογώνια της σελίδας.](images/design-example.jpg)[[[scratch3-show-hide-sprites-backdrops]]]
