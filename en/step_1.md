...
<div style="border: 2px solid black; border-top: 15px solid #f3524f; box-shadow: 10px 10px 5px #F5F5F5; padding: 10px; background-color: grey; margin-bottom: 20px; margin-left: 5%; margin-right: 5px;">
